    ...
    function completeText(data, fontManager){
        ...
        for (i = 0;i < len ;i += 1) {
            ...
            if(fontManager.chars){
                ...
                tSpanHelper.setAttribute('font-style', fStyle);
                tSpanHelper.setAttribute('font-weight', fWeight);
                tSpanHelper.textContent = val;
                cLength = tSpanHelper.getComputedTextLength();*/
